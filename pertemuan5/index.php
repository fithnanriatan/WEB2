            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="ubah_user.php?id=<?= $dataUser['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="hapus_user.php?id=<?= $dataUser['id'] ?>" class="btn btn-danger btn-sm" onclick="confirm('Yakin Hapus data yang dipilih?')">Hapus</a>
                        </td>
                    </tr>
                <?php
                }
